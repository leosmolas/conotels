...
#
# Created: Mon Jul 05 20:49:38 2010
...
class Ui_PathWidget(object):
    ...
    def retranslateUi(self, PathWidget):
        ...
        self.pathLine.setText(QtGui.QApplication.translate("PathWidget", os.path.normcase(os.path.expandvars("%HOMEDRIVE%")+"\\Program Files\Conosoft\Conotels"), None, QtGui.QApplication.UnicodeUTF8))
