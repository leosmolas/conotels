...
#
# Created: Tue Mar 30 19:37:48 2010
...
class Ui_reservaDialog(object):
    def setupUi(self, reservaDialog):
        ...
        self.numeroLine = QtGui.QLineEdit(reservaDialog)
        self.numeroLine.setObjectName("numeroLine")
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.numeroLine)
        ...
        reservaDialog.setTabOrder(self.numeroLine_2, self.numeroLine)
        reservaDialog.setTabOrder(self.numeroLine, self.buttonBox)
